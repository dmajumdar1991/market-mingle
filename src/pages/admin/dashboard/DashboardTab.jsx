      ...
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          <Tabs defaultIndex={0} className=" ">
            <TabList className="bg- mb-10 grid  grid-cols-2 gap-4 text-center md:flex   md:justify-center md:space-x-8 ">
              <Tab>
                <button
                  type="button"
              ...
              <div className="  mb-16 px-4 md:px-0">
                ...
                <div className=" flex justify-end">
                  <Link to={"/addproduct"}>
                    <button
                      type="button"
                      className="mb-2 rounded-lg border bg-pink-600 px-5 py-2.5 text-sm font-medium text-white shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] outline-0 hover:bg-pink-700 focus:outline-none"
                      style={{
            ...
            <TabPanel>
              <div className="relative mb-16 overflow-x-auto">
                ...
                <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                  <thead
                    className="bg-gray-200 text-xs uppercase text-black "
                    style={{
                      backgroundColor: mode === "dark" ? "rgb(46 49 55)" : "",
                      color: mode === "dark" ? "white" : "",
                    }}
                      ...
                      <tbody>
                        ...
                        >
                          ...
                          <td scope="row" className=" px-6 py-4 text-black">
                            <img className="w-16" src={item.imgUrl} alt="img" />
                          </td>
                          <td
                            className="px-6 py-4 text-black "
                            style={{ color: mode === "dark" ? "white" : "" }}
